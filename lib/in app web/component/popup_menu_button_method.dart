...
PopupMenuButton<dynamic> popupMenuButtonMethod(
  ...
  return PopupMenuButton(
    ...
    itemBuilder: (context) => [
      PopupMenuItem(
        onTap: () {
          providerFalse.chengIndex(index: 0);
      ...
      PopupMenuItem(
        onTap: () {
          providerFalse.chengIndex(index: 1);
          providerTrue.webViewController!.loadUrl(
            urlRequest: URLRequest(
              url: WebUri(
                "${providerTrue.linkList[providerTrue.indexValue]}",
      ...
      PopupMenuItem(
        onTap: () {
          providerFalse.chengIndex(index: 2);
          providerTrue.webViewController!.loadUrl(
            urlRequest: URLRequest(
              url: WebUri(
                "${providerTrue.linkList[providerTrue.indexValue]}",
      ...
      PopupMenuItem(
        onTap: () {
          providerFalse.chengIndex(index: 3);
          providerTrue.webViewController!.loadUrl(
            urlRequest: URLRequest(
              url: WebUri(
                "${providerTrue.linkList[providerTrue.indexValue]}",
      ...
      PopupMenuItem(
        onTap: () async {
          await providerFalse.readDataDb();
          Navigator.push(
            context,
            MaterialPageRoute(
